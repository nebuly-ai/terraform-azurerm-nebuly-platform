...
- resource.azuread_application.main (/terraform-docs/main.tf#598)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1237)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1247)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#610)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#617)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#884)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#908)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#925)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#528)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#942)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#630)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#645)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1217)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1450)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1461)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1414)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#663)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#674)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1428)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1439)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#854)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#843)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1365)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#786)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#794)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#695)
- resource.azurerm_postgresql_flexible_server_active_directory_administrator.entra_admin (/terraform-docs/main.tf#865)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#759)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#752)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#780)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#774)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#766)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#439)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#458)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#401)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#420)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#477)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#496)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#445)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#464)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#407)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#426)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#483)
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#507)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#1130)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#1156)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#554)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#1030)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#1056)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#953)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1360)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#588)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#580)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#623)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#1023)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#519)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#1094)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#994)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#1124)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#1017)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1182)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#325)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#349)
- resource.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#341)
- resource.azurerm_virtual_network.main (/terraform-docs/main.tf#313)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#690)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1336)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1233)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1410)
- data source.azuread_user.aks_admins (/terraform-docs/main.tf#233)
- data source.azurerm_client_config.current (/terraform-docs/main.tf#225)
- data source.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#298)
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#304)
- data source.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#280)
- data source.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#292)
- data source.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#286)
- data source.azurerm_resource_group.main (/terraform-docs/main.tf#222)
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#238)
- data source.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#266)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#252)
- data source.azurerm_virtual_network.main (/terraform-docs/main.tf#227)
