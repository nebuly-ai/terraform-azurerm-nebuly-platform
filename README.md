...
| <a name="input_private_dns_zones"></a> [private\_dns\_zones](#input\_private\_dns\_zones) | Private DNS zones to use for Private Endpoint connections. If not provided, a new DNS Zone <br/>  is created and linked to the respective subnet. | <pre>object({<br/>    flexible_postgres = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>    openai = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>    key_vault = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>    blob = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>    dfs = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>  })</pre> | `{}` | no |
...
- resource.azuread_application.main (/terraform-docs/main.tf#451)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1030)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1040)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#463)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#470)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#709)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#733)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#750)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#384)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#767)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#483)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#498)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1010)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1219)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1230)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1183)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#516)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#527)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1197)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1208)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#686)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#675)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1140)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#618)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#626)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#548)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#599)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#592)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#612)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#606)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#304)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#320)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#271)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#288)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#336)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#352)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#309)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#325)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#277)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#293)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#341)
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#363)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#933)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#954)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#410)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#852)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#873)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#778)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1135)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#441)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#433)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#476)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#845)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#375)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#906)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#816)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#927)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#839)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#975)
...
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#543)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1122)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1026)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1179)
