...
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#654)
...
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#611)
...
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#606)
...
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#593)
- resource.tls_private_key.aks (/terraform-docs/main.tf#522)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#650)
