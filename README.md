...
- resource.azuread_application.main (/terraform-docs/main.tf#589)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1228)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1238)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#601)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#608)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#875)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#899)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#916)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#519)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#933)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#621)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#636)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1208)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1441)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1452)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1405)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#654)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#665)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1419)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1430)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#845)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#834)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1356)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#777)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#785)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#686)
- resource.azurerm_postgresql_flexible_server_active_directory_administrator.entra_admin (/terraform-docs/main.tf#856)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#750)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#743)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#771)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#765)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#757)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#430)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#449)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#392)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#411)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#468)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#487)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#436)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#455)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#398)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#417)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#474)
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#498)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#1121)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#1147)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#545)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#1021)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#1047)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#944)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1351)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#579)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#571)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#614)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#1014)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#510)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#1085)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#985)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#1115)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#1008)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1173)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#316)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#340)
- resource.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#332)
- resource.azurerm_virtual_network.main (/terraform-docs/main.tf#304)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#681)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1327)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1224)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1401)
- data source.azuread_group.postgres_entra_readers (/terraform-docs/main.tf#219)
- data source.azuread_group.postgres_entra_writers (/terraform-docs/main.tf#224)
- data source.azuread_user.aks_admins (/terraform-docs/main.tf#214)
- data source.azurerm_client_config.current (/terraform-docs/main.tf#206)
- data source.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#289)
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#295)
- data source.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#271)
- data source.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#283)
- data source.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#277)
- data source.azurerm_resource_group.main (/terraform-docs/main.tf#203)
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#229)
- data source.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#257)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#243)
- data source.azurerm_virtual_network.main (/terraform-docs/main.tf#208)
