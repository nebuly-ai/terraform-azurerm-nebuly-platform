...
| <a name="input_private_dns_zones"></a> [private\_dns\_zones](#input\_private\_dns\_zones) | Private DNS zones to use for Private Endpoint connections. If not provided, a new DNS Zone <br/>  is created and linked to the respective subnet. | <pre>object({<br/>    flexible_postgres = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    openai = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    key_vault = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    blob = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, false)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    dfs = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>  })</pre> | <pre>{<br/>  "blob": {},<br/>  "dfs": {},<br/>  "flexible_postgres": {},<br/>  "key_vault": {},<br/>  "openai": {}<br/>}</pre> | no |
...
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1286)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1297)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1250)
...
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1264)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1275)
...
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1207)
...
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1202)
...
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1189)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1092)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1246)
