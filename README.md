...
- resource.azurerm_postgresql_flexible_server_active_directory_administrator.entra_admin (/terraform-docs/main.tf#869)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#763)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#756)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#784)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#778)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#770)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#443)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#462)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#405)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#424)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#481)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#500)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#449)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#468)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#411)
...
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#308)
- data source.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#284)
- data source.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#296)
- data source.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#290)
- data source.azurerm_resource_group.main (/terraform-docs/main.tf#226)
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#242)
- data source.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#270)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#256)
- data source.azurerm_virtual_network.main (/terraform-docs/main.tf#231)
