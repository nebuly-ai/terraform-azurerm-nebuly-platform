...
- resource.azuread_application.main (/terraform-docs/main.tf#213)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#219)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#224)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#408)
- resource.azurerm_cognitive_deployment.main (/terraform-docs/main.tf#427)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#147)
- resource.azurerm_key_vault_secret.api_key (/terraform-docs/main.tf#445)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#228)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#233)
- resource.azurerm_key_vault_secret.postgres_passwords (/terraform-docs/main.tf#391)
- resource.azurerm_key_vault_secret.postgres_users (/terraform-docs/main.tf#382)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#617)
...
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#247)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#298)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#291)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#319)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#313)
- resource.azurerm_postgresql_flexible_server_firewall_rule.main (/terraform-docs/main.tf#305)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#108)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#126)
- resource.azurerm_private_dns_zone.file (/terraform-docs/main.tf#90)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#114)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#132)
- resource.azurerm_private_dns_zone_virtual_network_link.file (/terraform-docs/main.tf#96)
- resource.azurerm_private_endpoint.blob (/terraform-docs/main.tf#480)
- resource.azurerm_private_endpoint.dfs (/terraform-docs/main.tf#520)
- resource.azurerm_private_endpoint.file (/terraform-docs/main.tf#500)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#173)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#203)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#198)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#475)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#457)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#471)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#242)
- resource.tls_private_key.aks (/terraform-docs/main.tf#544)
...
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#73)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#78)
