...
| <a name="input_private_dns_zones"></a> [private\_dns\_zones](#input\_private\_dns\_zones) | Private DNS zones to use for Private Endpoint connections. If not provided, a new DNS Zone <br/>  is created and linked to the respective subnet. | <pre>object({<br/>    flexible_postgres = optional(string, null)<br/>  })</pre> | `{}` | no |
...
- resource.azuread_application.main (/terraform-docs/main.tf#236)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#560)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#564)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#242)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#247)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#454)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#474)
...
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#508)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#251)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#260)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#698)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#273)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#282)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#710)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#721)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#437)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#428)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#655)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#371)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#379)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#301)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#352)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#345)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#365)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#359)
...
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#650)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#226)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#218)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#546)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#522)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#542)
...
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#296)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#637)
- resource.tls_private_key.aks (/terraform-docs/main.tf#556)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#694)
