...
- resource.azuread_application.main (/terraform-docs/main.tf#583)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1222)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1232)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#595)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#602)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#869)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#893)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#910)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#513)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#927)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#615)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#630)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1202)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1435)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1446)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1399)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#648)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#659)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1413)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1424)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#839)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#828)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1350)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#771)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#779)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#680)
- resource.azurerm_postgresql_flexible_server_active_directory_administrator.entra_admin (/terraform-docs/main.tf#850)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#744)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#737)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#765)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#759)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#751)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#424)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#443)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#386)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#405)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#462)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#481)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#430)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#449)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#392)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#411)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#468)
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#492)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#1115)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#1141)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#539)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#1015)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#1041)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#938)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1345)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#573)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#565)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#608)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#1008)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#504)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#1079)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#979)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#1109)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#1002)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1167)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#310)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#334)
- resource.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#326)
- resource.azurerm_virtual_network.main (/terraform-docs/main.tf#298)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#675)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1321)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1218)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1395)
- data source.azuread_group.postgres_entra_readers (/terraform-docs/main.tf#213)
- data source.azuread_group.postgres_entra_writers (/terraform-docs/main.tf#218)
- data source.azuread_user.aks_admins (/terraform-docs/main.tf#208)
- data source.azurerm_client_config.current (/terraform-docs/main.tf#200)
- data source.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#283)
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#289)
- data source.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#265)
- data source.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#277)
- data source.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#271)
- data source.azurerm_resource_group.main (/terraform-docs/main.tf#197)
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#223)
- data source.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#251)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#237)
- data source.azurerm_virtual_network.main (/terraform-docs/main.tf#202)
