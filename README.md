...
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#932)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#942)
...
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1079)
...
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1091)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1102)
...
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1036)
...
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1031)
...
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1018)
- resource.tls_private_key.aks (/terraform-docs/main.tf#928)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1075)
