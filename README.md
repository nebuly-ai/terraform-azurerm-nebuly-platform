...
| <a name="input_private_dns_zones"></a> [private\_dns\_zones](#input\_private\_dns\_zones) | Private DNS zones to use for Private Endpoint connections. If not provided, a new DNS Zone <br/>  is created and linked to the respective subnet. | <pre>object({<br/>    flexible_postgres = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>    key_vault = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>    blob = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>    dfs = optional(object({<br/>      name : string<br/>      resource_group_name : string<br/>    }), null)<br/>  })</pre> | `{}` | no |
...
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#846)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#856)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#374)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#381)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#609)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#629)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#646)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#295)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#663)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#394)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#407)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#993)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#424)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#433)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1005)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1016)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#588)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#579)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#950)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#522)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#530)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#452)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#503)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#496)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#516)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#510)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#257)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#275)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#220)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#239)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#262)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#280)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#226)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#244)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#756)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#779)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#321)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#945)
...
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#387)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#714)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#731)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#690)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#752)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#710)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#802)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#175)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#197)
...
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#447)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#932)
- resource.tls_private_key.aks (/terraform-docs/main.tf#842)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#989)
...
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#154)
