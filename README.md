...
| <a name="input_private_dns_zones"></a> [private\_dns\_zones](#input\_private\_dns\_zones) | Private DNS zones to use for Private Endpoint connections. If not provided, a new DNS Zone <br/>  is created and linked to the respective subnet. | <pre>object({<br/>    flexible_postgres = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    openai = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    key_vault = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    blob = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, false)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    dfs = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      link_dns_zone_group : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>  })</pre> | <pre>{<br/>  "blob": {},<br/>  "dfs": {},<br/>  "flexible_postgres": {},<br/>  "key_vault": {},<br/>  "openai": {}<br/>}</pre> | no |
...
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1092)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1102)
...
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#739)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#763)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#780)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#403)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#797)
...
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1072)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1282)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1293)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1246)
...
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1260)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1271)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#716)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#705)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1203)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#648)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#656)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#570)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#621)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#614)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#642)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#636)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#628)
...
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#985)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#1011)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#429)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#885)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#911)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#808)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1198)
...
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#878)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#394)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#949)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#849)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#979)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#872)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1037)
...
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1185)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1088)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1242)
