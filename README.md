...
- resource.azuread_application.main (/terraform-docs/main.tf#625)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1264)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1274)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#637)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#644)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#911)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#935)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#952)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#555)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#969)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#657)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#672)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1244)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1477)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1488)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1441)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#690)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#701)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1455)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1466)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#881)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#870)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1392)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#813)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#821)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#722)
- resource.azurerm_postgresql_flexible_server_active_directory_administrator.entra_admin (/terraform-docs/main.tf#892)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#786)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#779)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#807)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#801)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#793)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#466)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#485)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#428)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#447)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#504)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#523)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#472)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#491)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#434)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#453)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#510)
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#534)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#1157)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#1183)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#581)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#1057)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#1083)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#980)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1387)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#615)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#607)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#650)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#1050)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#546)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#1121)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#1021)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#1151)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#1044)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1209)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#352)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#376)
- resource.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#368)
- resource.azurerm_virtual_network.main (/terraform-docs/main.tf#340)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#717)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1363)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1260)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1437)
- data source.azuread_group.postgres_entra_readers (/terraform-docs/main.tf#255)
- data source.azuread_group.postgres_entra_writers (/terraform-docs/main.tf#260)
- data source.azuread_user.aks_admins (/terraform-docs/main.tf#250)
- data source.azurerm_client_config.current (/terraform-docs/main.tf#242)
- data source.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#325)
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#331)
- data source.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#307)
- data source.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#319)
- data source.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#313)
- data source.azurerm_resource_group.main (/terraform-docs/main.tf#239)
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#265)
- data source.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#293)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#279)
- data source.azurerm_virtual_network.main (/terraform-docs/main.tf#244)
