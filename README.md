...
| <a name="input_private_dns_zones"></a> [private\_dns\_zones](#input\_private\_dns\_zones) | Private DNS zones to use for Private Endpoint connections. If not provided, a new DNS Zone <br/>  is created and linked to the respective subnet. | <pre>object({<br/>    flexible_postgres = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    openai = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    key_vault = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    blob = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, false)<br/>      create : optional(bool, true)<br/>    }), null)<br/>    dfs = optional(object({<br/>      name : optional(string)<br/>      resource_group_name : optional(string)<br/>      link_vnet : optional(bool, true)<br/>      create : optional(bool, true)<br/>    }), null)<br/>  })</pre> | <pre>{<br/>  "blob": {},<br/>  "dfs": {},<br/>  "flexible_postgres": {},<br/>  "key_vault": {},<br/>  "openai": {}<br/>}</pre> | no |
...
- resource.azuread_application.main (/terraform-docs/main.tf#470)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1074)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1084)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#482)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#489)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#736)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#760)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#777)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#403)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#794)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#502)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#517)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1054)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1264)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1275)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1228)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#535)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#546)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1242)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1253)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#713)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#702)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1185)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#645)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#653)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#567)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#618)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#611)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#639)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#633)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#625)
...
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#973)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#996)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#429)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#879)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#902)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#805)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1180)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#460)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#452)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#495)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#872)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#394)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#937)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#843)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#967)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#866)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1019)
...
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#562)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1167)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1070)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1224)
