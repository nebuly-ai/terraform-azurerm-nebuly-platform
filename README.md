...
- resource.azuread_application.main (/terraform-docs/main.tf#594)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1233)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1243)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#606)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#613)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#880)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#904)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#921)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#524)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#938)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#626)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#641)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1213)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1446)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1457)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1410)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#659)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#670)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1424)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1435)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#850)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#839)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1361)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#782)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#790)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#691)
- resource.azurerm_postgresql_flexible_server_active_directory_administrator.entra_admin (/terraform-docs/main.tf#861)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#755)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#748)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#776)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#770)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#762)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#435)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#454)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#397)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#416)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#473)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#492)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#441)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#460)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#403)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#422)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#479)
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#503)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#1126)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#1152)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#550)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#1026)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#1052)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#949)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1356)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#584)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#576)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#619)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#1019)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#515)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#1090)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#990)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#1120)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#1013)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1178)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#321)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#345)
- resource.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#337)
- resource.azurerm_virtual_network.main (/terraform-docs/main.tf#309)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#686)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1332)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1229)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1406)
- data source.azuread_group.postgres_entra_readers (/terraform-docs/main.tf#224)
- data source.azuread_group.postgres_entra_writers (/terraform-docs/main.tf#229)
- data source.azuread_user.aks_admins (/terraform-docs/main.tf#219)
- data source.azurerm_client_config.current (/terraform-docs/main.tf#211)
- data source.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#294)
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#300)
- data source.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#276)
- data source.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#288)
- data source.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#282)
- data source.azurerm_resource_group.main (/terraform-docs/main.tf#208)
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#234)
- data source.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#262)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#248)
- data source.azurerm_virtual_network.main (/terraform-docs/main.tf#213)
