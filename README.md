...
- resource.azuread_application.main (/terraform-docs/main.tf#578)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1217)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1227)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#590)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#597)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#864)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#888)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#905)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#508)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#922)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#610)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#625)
- resource.azurerm_key_vault_secret.backups_storage_primary_key (/terraform-docs/main.tf#1197)
- resource.azurerm_key_vault_secret.google_sso_client_id (/terraform-docs/main.tf#1430)
- resource.azurerm_key_vault_secret.google_sso_client_secret (/terraform-docs/main.tf#1441)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1394)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#643)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#654)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1408)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1419)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#834)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#823)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1345)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#766)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#774)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#675)
- resource.azurerm_postgresql_flexible_server_active_directory_administrator.entra_admin (/terraform-docs/main.tf#845)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#739)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#732)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#760)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#754)
- resource.azurerm_postgresql_flexible_server_database.extras (/terraform-docs/main.tf#746)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#419)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#438)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#381)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#400)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#457)
- resource.azurerm_private_dns_zone.web_app_routing (/terraform-docs/main.tf#476)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#425)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#444)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#387)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#406)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#463)
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#487)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#1110)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#1136)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#534)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#1010)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#1036)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#933)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1340)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#568)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#560)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#603)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#1003)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#499)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#1074)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#974)
- resource.azurerm_storage_container.clickhouse (/terraform-docs/main.tf#1104)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#997)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#1162)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#305)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#329)
- resource.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#321)
- resource.azurerm_virtual_network.main (/terraform-docs/main.tf#293)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#670)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1316)
- resource.tls_private_key.aks (/terraform-docs/main.tf#1213)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1390)
- data source.azuread_group.postgres_entra_readers (/terraform-docs/main.tf#208)
- data source.azuread_group.postgres_entra_writers (/terraform-docs/main.tf#213)
- data source.azuread_user.aks_admins (/terraform-docs/main.tf#203)
- data source.azurerm_client_config.current (/terraform-docs/main.tf#195)
- data source.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#278)
- data source.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#284)
- data source.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#260)
- data source.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#272)
- data source.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#266)
- data source.azurerm_resource_group.main (/terraform-docs/main.tf#192)
- data source.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#218)
- data source.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#246)
- data source.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#232)
- data source.azurerm_virtual_network.main (/terraform-docs/main.tf#197)
