...
- resource.azuread_application.main (/terraform-docs/main.tf#429)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#1004)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#1014)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#441)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#448)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#687)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#711)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#728)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#364)
...
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#577)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#570)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#590)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#584)
...
- resource.azurerm_private_dns_zone_virtual_network_link.web_app_routing (/terraform-docs/main.tf#343)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#909)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#930)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#390)
...
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#823)
- resource.azurerm_role_assignment.web_app_routing_identity__dns_zone (/terraform-docs/main.tf#355)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#884)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#794)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#817)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#951)
