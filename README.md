...
- resource.azuread_application.main (/terraform-docs/main.tf#402)
- resource.azuread_group.aks_admins (/terraform-docs/main.tf#960)
- resource.azuread_group_member.aks_admin_users (/terraform-docs/main.tf#970)
- resource.azuread_service_principal.main (/terraform-docs/main.tf#414)
- resource.azuread_service_principal_password.main (/terraform-docs/main.tf#421)
- resource.azurerm_cognitive_account.main (/terraform-docs/main.tf#649)
- resource.azurerm_cognitive_deployment.gpt_4o (/terraform-docs/main.tf#673)
- resource.azurerm_cognitive_deployment.gpt_4o_mini (/terraform-docs/main.tf#690)
- resource.azurerm_key_vault.main (/terraform-docs/main.tf#337)
- resource.azurerm_key_vault_secret.azure_openai_api_key (/terraform-docs/main.tf#707)
- resource.azurerm_key_vault_secret.azuread_application_client_id (/terraform-docs/main.tf#434)
- resource.azurerm_key_vault_secret.azuread_application_client_secret (/terraform-docs/main.tf#447)
- resource.azurerm_key_vault_secret.jwt_signing_key (/terraform-docs/main.tf#1107)
- resource.azurerm_key_vault_secret.nebuly_azure_client_id (/terraform-docs/main.tf#464)
- resource.azurerm_key_vault_secret.nebuly_azure_client_secret (/terraform-docs/main.tf#473)
- resource.azurerm_key_vault_secret.okta_sso_client_id (/terraform-docs/main.tf#1119)
- resource.azurerm_key_vault_secret.okta_sso_client_secret (/terraform-docs/main.tf#1130)
- resource.azurerm_key_vault_secret.postgres_password (/terraform-docs/main.tf#628)
- resource.azurerm_key_vault_secret.postgres_user (/terraform-docs/main.tf#619)
- resource.azurerm_kubernetes_cluster_node_pool.linux_pools (/terraform-docs/main.tf#1064)
- resource.azurerm_management_lock.postgres_server (/terraform-docs/main.tf#562)
- resource.azurerm_monitor_metric_alert.postgres_server_alerts (/terraform-docs/main.tf#570)
- resource.azurerm_postgresql_flexible_server.main (/terraform-docs/main.tf#492)
- resource.azurerm_postgresql_flexible_server_configuration.mandatory_configurations (/terraform-docs/main.tf#543)
- resource.azurerm_postgresql_flexible_server_configuration.optional_configurations (/terraform-docs/main.tf#536)
- resource.azurerm_postgresql_flexible_server_database.analytics (/terraform-docs/main.tf#556)
- resource.azurerm_postgresql_flexible_server_database.auth (/terraform-docs/main.tf#550)
- resource.azurerm_private_dns_zone.blob (/terraform-docs/main.tf#287)
- resource.azurerm_private_dns_zone.dfs (/terraform-docs/main.tf#303)
- resource.azurerm_private_dns_zone.flexible_postgres (/terraform-docs/main.tf#254)
- resource.azurerm_private_dns_zone.key_vault (/terraform-docs/main.tf#271)
- resource.azurerm_private_dns_zone.openai (/terraform-docs/main.tf#319)
- resource.azurerm_private_dns_zone_virtual_network_link.blob (/terraform-docs/main.tf#292)
- resource.azurerm_private_dns_zone_virtual_network_link.dfs (/terraform-docs/main.tf#308)
- resource.azurerm_private_dns_zone_virtual_network_link.flexible_postgres (/terraform-docs/main.tf#260)
- resource.azurerm_private_dns_zone_virtual_network_link.key_vault (/terraform-docs/main.tf#276)
- resource.azurerm_private_dns_zone_virtual_network_link.openai (/terraform-docs/main.tf#324)
- resource.azurerm_private_endpoint.backups_blob (/terraform-docs/main.tf#865)
- resource.azurerm_private_endpoint.backups_dfs (/terraform-docs/main.tf#886)
- resource.azurerm_private_endpoint.key_vault (/terraform-docs/main.tf#363)
- resource.azurerm_private_endpoint.models_blob (/terraform-docs/main.tf#786)
- resource.azurerm_private_endpoint.models_dfs (/terraform-docs/main.tf#807)
- resource.azurerm_private_endpoint.openai (/terraform-docs/main.tf#716)
- resource.azurerm_role_assignment.aks_network_contributor (/terraform-docs/main.tf#1059)
- resource.azurerm_role_assignment.key_vault_secret_officer__current (/terraform-docs/main.tf#392)
- resource.azurerm_role_assignment.key_vault_secret_user__aks (/terraform-docs/main.tf#384)
- resource.azurerm_role_assignment.nebuly_secrets_officer (/terraform-docs/main.tf#427)
- resource.azurerm_role_assignment.storage_container_models__data_contributor (/terraform-docs/main.tf#781)
- resource.azurerm_storage_account.backups (/terraform-docs/main.tf#840)
- resource.azurerm_storage_account.main (/terraform-docs/main.tf#754)
- resource.azurerm_storage_container.models (/terraform-docs/main.tf#777)
- resource.azurerm_storage_management_policy.backups (/terraform-docs/main.tf#907)
- resource.azurerm_subnet.aks_nodes (/terraform-docs/main.tf#200)
- resource.azurerm_subnet.flexible_postgres (/terraform-docs/main.tf#222)
- resource.azurerm_subnet.private_endpoints (/terraform-docs/main.tf#214)
- resource.azurerm_virtual_network.main (/terraform-docs/main.tf#188)
- resource.random_password.postgres_server_admin_password (/terraform-docs/main.tf#487)
- resource.time_sleep.wait_aks_creation (/terraform-docs/main.tf#1046)
- resource.tls_private_key.aks (/terraform-docs/main.tf#956)
- resource.tls_private_key.jwt_signing_key (/terraform-docs/main.tf#1103)
